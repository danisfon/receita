...
class _ListaDicaState extends State<ListaDica> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.pushNamed(context, Rotas.cadastroDica).then((_) => _carregar()),
  ...
  Widget _itemLista(DTODica dto) {
    return ListTile(
      ...
      onTap: () => Navigator.pushNamed(context, Rotas.cadastroDica, arguments: dto).then((_) => _carregar()),
    );
  }
